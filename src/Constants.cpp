...
void Constants::Init(const v8::Local<v8::Object> exports) {
    auto constants = Nan::New<v8::Object>();
    SetNoiseTypeBindingConstants(constants);
    SetPathTypeBindingConstants(constants);
    SetStretchTypeBindingConstants(constants);
    SetStyleTypeBindingConstants(constants);
    SetTimerStateBindingConstants(constants);
    SetAutoThresholdMethodBindingConstants(constants);
    SetMagickEvaluateOperatorBindingConstants(constants);
    SetMagickFunctionBindingConstants(constants);
    SetStatisticTypeBindingConstants(constants);
    SetResourceTypeBindingConstants(constants);
    SetFilterTypesBindingConstants(constants);
    SetRegistryTypeBindingConstants(constants);
    SetEndianTypeBindingConstants(constants);
    SetQuantumAlphaTypeBindingConstants(constants);
    SetQuantumFormatTypeBindingConstants(constants);
    SetQuantumTypeBindingConstants(constants);
    SetDitherMethodBindingConstants(constants);
    SetRenderingIntentBindingConstants(constants);
    SetPolicyDomainBindingConstants(constants);
    SetPolicyRightsBindingConstants(constants);
    SetInterpolatePixelMethodBindingConstants(constants);
    SetPixelComponentBindingConstants(constants);
    SetPixelIntensityMethodBindingConstants(constants);
    SetCommandOptionBindingConstants(constants);
    SetValidateTypeBindingConstants(constants);
    SetCommandOptionFlagsBindingConstants(constants);
    SetMagickOpenCLProgramBindingConstants(constants);
    SetImageMagickOpenCLModeBindingConstants(constants);
    SetMagickOpenCLEnvParamBindingConstants(constants);
    SetKernelInfoTypeBindingConstants(constants);
    SetMorphologyMethodBindingConstants(constants);
    SetMontageModeBindingConstants(constants);
    SetMagickModuleTypeBindingConstants(constants);
    SetMagickFormatTypeBindingConstants(constants);
    SetMagickThreadSupportBindingConstants(constants);
    SetChannelTypeBindingConstants(constants);
    SetClassTypeBindingConstants(constants);
    SetMagickBooleanTypeBindingConstants(constants);
    SetLogEventTypeBindingConstants(constants);
    SetDisposeTypeBindingConstants(constants);
    SetImageLayerMethodBindingConstants(constants);
    SetAlphaChannelTypeBindingConstants(constants);
    SetImageTypeBindingConstants(constants);
    SetInterlaceTypeBindingConstants(constants);
    SetOrientationTypeBindingConstants(constants);
    SetResolutionTypeBindingConstants(constants);
    SetTransmitTypeBindingConstants(constants);
    SetGeometryFlagsBindingConstants(constants);
    SetGravityTypeBindingConstants(constants);
    SetComplexOperatorBindingConstants(constants);
    SetExceptionTypeBindingConstants(constants);
    SetPreviewTypeBindingConstants(constants);
    SetAlignTypeBindingConstants(constants);
    SetClipPathUnitsBindingConstants(constants);
    SetDecorationTypeBindingConstants(constants);
    SetDirectionTypeBindingConstants(constants);
    SetFillRuleBindingConstants(constants);
    SetGradientTypeBindingConstants(constants);
    SetLineCapBindingConstants(constants);
    SetLineJoinBindingConstants(constants);
    SetPaintMethodBindingConstants(constants);
    SetPrimitiveTypeBindingConstants(constants);
    SetReferenceTypeBindingConstants(constants);
    SetSpreadMethodBindingConstants(constants);
    SetDistortImageMethodBindingConstants(constants);
    SetSparseColorMethodBindingConstants(constants);
    SetMagickLayerMethodBindingConstants(constants);
    SetStorageTypeBindingConstants(constants);
    SetCompressionTypeBindingConstants(constants);
    SetCompositeOperatorBindingConstants(constants);
    SetMetricTypeBindingConstants(constants);
    SetColorspaceTypeBindingConstants(constants);
    SetComplianceTypeBindingConstants(constants);
    SetCacheTypeBindingConstants(constants);
    SetVirtualPixelMethodBindingConstants(constants);
    SetMapModeBindingConstants(constants);
